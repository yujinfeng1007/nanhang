...
namespace ZHXY.Application
{
    ...
    public class DormBuildingService : AppService
    {
        ...
        public async Task<dynamic> AddAsync(AddBuildingDto input)
        {
            var entity = input.MapTo<Building>();            
            AddAndSave(entity);
        ...
        public async Task<dynamic> UpdAsync(UpdateBuildingDto input)
        {
        ...
        public dynamic Get(string id) => GetAsync<Building>(id).Result;

        public List<BuildingView> GetList(Pagination pagination, string keyword)
        {
            ...
            return query.ToListAsync().Result.MapToList<BuildingView>();
        }
