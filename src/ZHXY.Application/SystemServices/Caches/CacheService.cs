...
namespace ZHXY.Application
{
    ...
    public class CacheService : AppService
    {
        ...
        public static object GetMenuList()
        {
            ...
            if (Operator.GetCurrent().Duty == "studentDuty")
            {
                return "[{"
