...
{
    public class School_PRule_MergeClassController : ControllerBase
    {
        private School_PRule_MergeClass_App app = new School_PRule_MergeClass_App();
        ...
        public ActionResult SubmitForm(Schedule_PRule_MergeClass_Entity entity, string keyValue)
        {
        ...
        //         string exportSql = "";//createExportSql("School_PRule_MergeClass", parms);
        //         //string exportSql = "";
        ...
        //        List< School_PRule_MergeClass_Entity> list =ExportHtmlTableToExcel< School_PRule_MergeClass_Entity>(Server.MapPath(filePath), rules); //ExcelToList< School_PRule_MergeClass_Entity>(Server.MapPath(filePath), rules);
