...
{
    public class Schedule_WCTask_GroupController : ControllerBase
    {
        private Schedule_WCTask_Group_App app = new Schedule_WCTask_Group_App();
        ...
        public ActionResult SubmitForm(Schedule_WCTask_Group_Entity entity, string keyValue)
        {
        ...
        //         string exportSql = "";//createExportSql("Schedule_WCTask_Group", parms);
        //         //string exportSql = "";
        ...
        //        //     rules.Add("F_TaskId", new string[] { "F_TaskId", "" });
        //        //     rules.Add("F_CourseGroupId", new string[] { "F_CourseGroupId", "" });

        //        // //////////////////处理数据(机构 岗位 等字典替换，过滤不要的字段，修改表头)
        //        //List< Schedule_WCTask_Group_Entity> list =ExportHtmlTableToExcel< Schedule_WCTask_Group_Entity>(Server.MapPath(filePath), rules); //ExcelToList< Schedule_WCTask_Group_Entity>(Server.MapPath(filePath), rules);
