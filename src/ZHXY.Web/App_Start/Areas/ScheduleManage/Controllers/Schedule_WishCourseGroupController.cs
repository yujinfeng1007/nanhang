...
{
    public class Schedule_WishCourseGroupController : ControllerBase
    {
        ...
        //    var data = new
        //    {
        //        rows = app.GetOneCourseList(pagination,F_TaskId, F_Year, F_Semester, F_Divis,F_Grade),
        ...
        //public ActionResult SubmitForm(Schedule_WishCourseGroup_Entity entity,string keyValue)
        //{
        ...
        //         string exportSql = "";//createExportSql("Schedule_WishCourseGroup", parms);
        //         //string exportSql = "";
        ...
        //        //List< Schedule_WishCourseGroup_Entity> list =ExportHtmlTableToExcel< Schedule_WishCourseGroup_Entity>(Server.MapPath(filePath), rules); //ExcelToList< Schedule_WishCourseGroup_Entity>(Server.MapPath(filePath), rules);
