...
{
    public class Schedule_CourseLayerController : ControllerBase
    {
        private Schedule_CourseLayer_App app = new Schedule_CourseLayer_App();
        ...
        public ActionResult SubmitForm(Schedule_CourseLayer_Entity entity, string keyValue)
        {
        ...
        //         string exportSql = "";//createExportSql("Schedule_CourseLayer", parms);
        //         //string exportSql = "";
        ...
        //        List< Schedule_CourseLayer_Entity> list =ExportHtmlTableToExcel< Schedule_CourseLayer_Entity>(Server.MapPath(filePath), rules); //ExcelToList< Schedule_CourseLayer_Entity>(Server.MapPath(filePath), rules);
