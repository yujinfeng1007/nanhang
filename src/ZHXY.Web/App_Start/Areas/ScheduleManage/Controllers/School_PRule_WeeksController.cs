...
{
    public class School_PRule_WeeksController : ControllerBase
    {
        private School_PRule_Weeks_App app = new School_PRule_Weeks_App();

        [HttpGet]
        [HandlerAjaxOnly]
        public ActionResult GetGridJson(Pagination pagination, string F_Year, string F_Semester, string F_Divis, string F_Grade, string F_Class)
        {
            var data = new
            {
        ...
        public ActionResult SubmitForm(Schedule_PRule_Weeks_Entity entity, string keyValue)
        {
        ...
        //         string exportSql = "";//createExportSql("School_PRule_Weeks", parms);
        //         //string exportSql = "";
        ...
        //   List< School_PRule_Weeks_Entity> list =ExportHtmlTableToExcel< School_PRule_Weeks_Entity>(Server.MapPath(filePath), rules); //ExcelToList< School_PRule_Weeks_Entity>(Server.MapPath(filePath), rules);
