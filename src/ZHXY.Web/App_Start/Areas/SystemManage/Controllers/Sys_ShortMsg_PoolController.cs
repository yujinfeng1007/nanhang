...
namespace NFine.Web.Areas.SystemManage.Controllers
{
    ...
    public class Sys_ShortMsg_PoolController : ControllerBase
    {
        private Sys_ShortMsg_Pool_App app = new Sys_ShortMsg_Pool_App();
        ...
        public ActionResult AloneSout()
        {
            return View();
        }

        public ActionResult AloneSoutOrg()
        {
            return View();
        }
        ...
        public ActionResult SubmitForm(SysShortMsgPool entity, string keyValue)
        {
        ...
        [HandlerAjaxOnly]
        [ValidateAntiForgeryToken]
        public ActionResult SoutForm(SysShortMsgStay entity, string keyValue)
        {
            entity.F_DepartmentId = OperatorProvider.Provider.GetCurrent().DepartmentId;
            string IsOkMsg = app.SoutForm(entity, keyValue);
            if (IsOkMsg == "0")
            {
                return Success("操作成功。");
            }
        ...
        public FileResult export(string keyword, string F_CreatorTime_Start, string F_CreatorTime_Stop)
        {
            ...
            string exportSql = CreateExportSql("Sys_ShortMsg_Pool", parms);
            ...
            ///////////////////写流
            MemoryStream ms = new NPOIExcel().ToExcelStream(users, "待发送列表");
            ms.Seek(0, SeekOrigin.Begin);
            string filename = "待发送列表" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xls";
        ...
        public ActionResult import(string filePath)
        {
            ...
            List<SysShortMsgPool> list = ExcelToList<SysShortMsgPool>(Server.MapPath(filePath), rules);
