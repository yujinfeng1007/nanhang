...
namespace NFine.Web.Areas.SystemManage.Controllers
{
    ...
    public class Sys_ShortMsgModelController : ControllerBase
    {
        private Sys_ShortMsgModel_App app = new Sys_ShortMsgModel_App();
        ...
        public ActionResult SubmitForm(SysShortMsgModel entity, string keyValue)
        {
            entity.F_DepartmentId = OperatorProvider.Provider.GetCurrent().DepartmentId;
            if (string.IsNullOrEmpty(keyValue))
            {
                entity.F_Code = seedapp.getShoMsgNum();
            }
        ...
        public FileResult export(string keyword, string F_CreatorTime_Start, string F_CreatorTime_Stop)
        {
            ...
            string exportSql = CreateExportSql("Sys_ShortMsgModel", parms);
            ...
            ///////////////////写流
            MemoryStream ms = new NPOIExcel().ToExcelStream(users, "短信模板列表");
            ms.Seek(0, SeekOrigin.Begin);
            string filename = "短信模板列表" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xls";
        ...
        public ActionResult import(string filePath)
        {
            ...
            List<SysShortMsgModel> list = ExcelToList<SysShortMsgModel>(Server.MapPath(filePath), rules);
