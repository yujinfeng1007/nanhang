...
{
    //用户角色关联表
    public class Sys_User_RoleController : ControllerBase
    {
        private Sys_User_Role_App app = new Sys_User_Role_App();
        ...
        public ActionResult SubmitForm(SysUserRole entity, string keyValue)
        {
        ...
        public FileResult export(string keyword)
        {
            ...
            pagination.Page = 1;
            List<SysUserRole> list = app.GetList(pagination, keyword, string.Empty, string.Empty, string.Empty);
            ...
            //所有字段代码
            //rules.Add("F_User", new string[] { "用户Id", "" });
            //rules.Add("F_Role", new string[] { "角色Id", "" });
            //rules.Add("F_Id", new string[] { "收费方案ID", "" });
            ...
            ///////////////////写流
            MemoryStream ms = new NPOIExcel().ToExcelStream(dt, "Sys_User_Role列表");
            ms.Seek(0, SeekOrigin.Begin);
            string filename = "Sys_User_Role列表" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xls";
        ...
        public ActionResult import(string filePath)
        {
            ...
            //////////////////处理数据(机构 岗位 等字典替换，过滤不要的字段，修改表头)
            List<SysUserRole> list = ExcelToList<SysUserRole>(Server.MapPath(filePath), rules);
