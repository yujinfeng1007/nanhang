/*******************************************************************************
 * Author: mario
 * Description: School_TollFlow_Bills  Controller类
********************************************************************************/
...
{
    //收费流水表
    public class School_TollFlow_BillsController : ControllerBase
    {
        private School_TollFlow_Bills_App app = new School_TollFlow_Bills_App();
        ...
        public ActionResult SubmitForm(TollFlowBill entity, string keyValue)
        {
        ...
        public FileResult export(string keyword)
        {
            ...
            string exportSql = CreateExportSql("School_TollFlow_Bills", parms);
            //string exportSql = "";
            //Console.WriteLine("exportSql==>" + exportSql);
            DataTable dt = app.getDataTable(exportSql, dbParameter);
            ///////////////////写流
            MemoryStream ms = new NPOIExcel().ToExcelStream(dt, "School_TollFlow_Bills列表");
            ms.Seek(0, SeekOrigin.Begin);
            string filename = "School_TollFlow_Bills列表" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xls";
        ...
        public ActionResult import(string filePath)
        {
            ...
            //rules.Add("F_No", new string[] { "流水号", "" });
            //rules.Add("F_Bill_Id", new string[] { "账单ID", "" });
            //rules.Add("F_Bill_No", new string[] { "账单号", "" });
            ...
            List<TollFlowBill> list = ExcelToList<TollFlowBill>(Server.MapPath(filePath), "School_TollFlow_Bills");
