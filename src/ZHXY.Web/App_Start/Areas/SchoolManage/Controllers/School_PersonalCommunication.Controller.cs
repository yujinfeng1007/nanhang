/*******************************************************************************
 * Author: mario
 * Description: School_PersonalCommunication  Controller类
********************************************************************************/
...
{
    //School_PersonalCommunication
    public class School_PersonalCommunicationController : ControllerBase
    {
        private School_PersonalCommunication_App app = new School_PersonalCommunication_App();
        ...
        public ActionResult SubmitForm(PersonalCommunication entity, string keyValue)
        {
        ...
        public FileResult export(string keyword)
        {
            ...
            string exportSql = CreateExportSql("School_PersonalCommunication", parms);
            //string exportSql = "";
            //Console.WriteLine("exportSql==>" + exportSql);
            DataTable dt = app.getDataTable(exportSql, dbParameter);
            ///////////////////写流
            MemoryStream ms = new NPOIExcel().ToExcelStream(dt, "School_PersonalCommunication列表");
            ms.Seek(0, SeekOrigin.Begin);
            string filename = "School_PersonalCommunication列表" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xls";
        ...
        public ActionResult import(string filePath)
        {
            ...
            //rules.Add("F_FriendName", new string[] { "F_FriendName", "" });
            //rules.Add("F_RemarkName", new string[] { "F_RemarkName", "" });
            //rules.Add("F_EmailAddress", new string[] { "F_EmailAddress", "" });
            //rules.Add("F_Company", new string[] { "F_Company", "" });
            //rules.Add("F_TelephoneNumber", new string[] { "F_TelephoneNumber", "" });
            //rules.Add("F_Group", new string[] { "F_Group", "" });
            //rules.Add("F_Memo", new string[] { "F_Memo", "" });
            //rules.Add("F_Homepage", new string[] { "F_Homepage", "" });
            //rules.Add("F_Birthday", new string[] { "F_Birthday", "" });
            ...
            List<PersonalCommunication> list = ExcelToList<PersonalCommunication>(Server.MapPath(filePath), rules);
