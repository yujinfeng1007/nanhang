/*******************************************************************************
 * Author: mario
 * Description: School_Mail_Attachment  Controller类
********************************************************************************/
...
{
    //School_Mail_Attachment
    public class School_Mail_AttachmentController : ControllerBase
    {
        private School_Mail_Attachment_App app = new School_Mail_Attachment_App();
        ...
        public ActionResult SubmitForm(MailAttachment entity, string keyValue)
        {
        ...
        public FileResult export(string keyword)
        {
            ...
            string exportSql = CreateExportSql("School_Mail_Attachment", parms);
            //string exportSql = "";
            //Console.WriteLine("exportSql==>" + exportSql);
            DataTable dt = app.getDataTable(exportSql, dbParameter);
            ///////////////////写流
            MemoryStream ms = new NPOIExcel().ToExcelStream(dt, "School_Mail_Attachment列表");
            ms.Seek(0, SeekOrigin.Begin);
            string filename = "School_Mail_Attachment列表" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xls";
        ...
        public ActionResult import(string filePath)
        {
            ...
            //rules.Add("F_MailId", new string[] { "F_MailId", "" });
            //rules.Add("F_AttachmentName", new string[] { "F_AttachmentName", "" });
            //rules.Add("F_ServerStoragePath", new string[] { "F_ServerStoragePath", "" });
            //rules.Add("F_AttachmentSize", new string[] { "F_AttachmentSize", "" });
            ...
            List<MailAttachment> list = ExcelToList<MailAttachment>(Server.MapPath(filePath), rules);
