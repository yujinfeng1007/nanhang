(function ($, window, document, undefined) {
    ...
    function bindEvents(dualListbox) {
        ...
        dualListbox.elements.upButton.on("click", function (e) {
            e.preventDefault();
            upSort(dualListbox)
        });
        dualListbox.elements.downButton.on("click", function (e) {
            e.preventDefault();
    ...
    BootstrapDualListbox.prototype = {
        init: function () {
            ...
            var select1Id = "bootstrap-duallistbox-nonselected-list_" + this.originalSelectName + "_" + this.settings.id
                , select2Id = "bootstrap-duallistbox-selected-list_" + this.originalSelectName + "_" + this.settings.id;
...
(function (root, factory) {
    ...
    $.fn.doublebox = function (options) {
        ...
        box.getSelectedOptions = function () {
            var items = $("#bootstrap-duallistbox-selected-list_doublebox_" + options.id + ">option").map(function () {
                return $(this).val()
            }).get().join(",");
            return items
        }
