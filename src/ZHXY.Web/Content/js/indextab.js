    ...
    $.nfinetab = {
        ...
        activeTab: function () {
            ...
            if (!$(this).hasClass('active')) {
                ...
                top.$.cookie('nfine_currentmoduleid', cookieId, { path: "/" });
        ...
        addTab: function (e) {
            ...
            var flag = true;
            console.log(dataUrl)
            if (dataUrl == '#' || $.trim(dataUrl).length == 0) {
                $.modalAlert('该菜单未设置功能，请与管理员联系。', 'warning')
                return false;
            }
            ...
            if (flag) {
                var str = '<a href="javascript:;" data-cookieId="' + dataId + '" class="active menuTab" data-id="' + dataUrl + '">' + menuName + ' <i class="fa fa-remove"></i></a>';
                $('.menuTab').removeClass('active');
                var str1 = '<iframe class="NFine_iframe winIframe" id="iframe' + dataId + '" name="iframe' + dataId + '"  width="100%" height="100%" src="' + dataUrl + '" frameborder="0" data-id="' + dataUrl + '" seamless></iframe>';
